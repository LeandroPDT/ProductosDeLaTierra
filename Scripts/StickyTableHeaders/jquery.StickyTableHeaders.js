    ...
    $.StickyTableHeaders = function (el, options) {
        ...
        base.init = function () {
            ...
            base.$el.each(function () {
                ...
                // EM: Le saco el filtrable al clon
                base.$clonedHeader.find(".filtrablerow").remove().end();
        ...
        base.updateCloneFromOriginal = function () {
            ...
            $('th', base.$clonedHeader).each(function (index) {
                ...
                $this.css('width', origCell.width()+1); // el +1 agregado por Eduardo Molteni
            });
