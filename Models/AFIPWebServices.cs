...
namespace Site.Models {
	public class AFIPWebServices {

		public string URL = "https://wsaahomo.afip.gov.ar/ws/services/LoginCms?WSDL";
		public string Servicio = "wsfe";
		public string DEFAULT_CERTSIGNER = HttpContext.Current.Server.MapPath("C:\\AFIP\\EduardoMolteni.pfx");
