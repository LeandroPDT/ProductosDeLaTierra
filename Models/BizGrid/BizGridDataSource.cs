...
namespace System.Web.Helpers {
    ...
    /// </summary>
    internal sealed class BizGridDataSource : IBizGridDataSource {
        private readonly BizGrid _grid;
        private readonly Type _elementType;
        private readonly IEnumerable<dynamic> _values;
        private readonly bool _canPage;
        private readonly bool _canSort;

        public BizGridDataSource(BizGrid grid, IEnumerable<dynamic> values, Type elementType, bool canPage, bool canSort) {
       ...
       public int TotalRowCount {
        ...
        public IList<BizGridRow> GetRows(SortInfo sortInfo, int pageIndex) {
            ...
            return rowData.Select((value, index) => new BizGridRow(_grid, value: value, rowIndex: index)).ToList();
        }
        ...
        private IQueryable<dynamic> Sort(IQueryable<dynamic> data, Type elementType, SortInfo sort) {
            ...
            if (typeof(IDynamicMetaObjectProvider).IsAssignableFrom(elementType)) {
                ...
                var binder = RB.Binder.GetMember(RB.CSharpBinderFlags.None, sort.SortColumn, typeof(BizGrid), new RB.CSharpArgumentInfo[] {
