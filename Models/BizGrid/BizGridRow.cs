...
namespace System.Web.Helpers {
    ...
    public class BizGridRow : DynamicObject, IEnumerable<object> {
        ...
        public IEnumerator<object> GetEnumerator() {
            if (_values == null) {
                _values = _grid.ColumnNames.Select(c => BizGrid.GetMember(this, c));
            }
        ...
        public IHtmlString GetSelectLink(string text = null) {
            ...
            return new HtmlString(BizGrid.GetLinkHtml(GetSelectUrl(), text));
        }
        ...
        public string GetSelectUrl() {
            ...
            queryString[BizGrid.SelectionFieldName] = (_rowIndex + 1L).ToString(CultureInfo.CurrentCulture);
            return BizGrid.GetPath(queryString);
        }
