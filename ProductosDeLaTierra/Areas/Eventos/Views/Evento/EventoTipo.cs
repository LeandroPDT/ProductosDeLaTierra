...
namespace Site.Models {
    public class EventoTipo {
        ...
        public static EventoTipo Envio = new EventoTipo() { ID = 1, Nombre = "Envio", ViewName = "EditarEnvio",EstadoInicial="Enviado",EstadoFinal="Enviado", Permiso = (int)Seguridad.Permisos.EventoEnvio,SumaMercaderia=true,RolNotificable="Cliente"};
        public static EventoTipo Recepcion = new EventoTipo() { ID = 2, Nombre = "Recepcion", ViewName = "EditarRecepcion",EstadoInicial="Enviado",EstadoFinal="Recibido", Permiso = (int)Seguridad.Permisos.EventoRecepcion,SumaMercaderia=true,RolNotificable="Proveedor"};
        public static EventoTipo Venta = new EventoTipo() { ID = 3, Nombre = "Venta", ViewName = "EditarVenta",EstadoInicial="Recibido",EstadoFinal="Recibido", Permiso = (int)Seguridad.Permisos.EventoVenta,SumaMercaderia=false,RolNotificable=""};
        public static EventoTipo Decomisacion = new EventoTipo() { ID = 4, Nombre = "Decomisacion", ViewName = "EditarDecomisacion",EstadoInicial="Recibido",EstadoFinal="Recibido", Permiso = (int)Seguridad.Permisos.EventoDecomisacion,SumaMercaderia=false,RolNotificable="Proveedor"};
